...
abstract class Episode implements ActiveRecordInterface
{
    ...
    public function setTag($v)
    {
        ...
        if ($this->tag !== $v) {
            $this->tag = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_TAG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EpisodeTableMap::translateFieldName('Tag', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EpisodeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EpisodeTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EpisodeTableMap::translateFieldName('Processed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->processed = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EpisodeTableMap::translateFieldName('Music', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EpisodeTableMap::COL_TAG)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getProcessed(),
            $keys[6] => $this->getMusic(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setProcessed($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setMusic($arr[$keys[6]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EpisodeTableMap::COL_TAG)) {
            $criteria->add(EpisodeTableMap::COL_TAG, $this->tag);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_UPLOAD_DATE)) {
