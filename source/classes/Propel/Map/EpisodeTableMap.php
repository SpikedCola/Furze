...
class EpisodeTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Tag', 'UploadDate', 'Title', 'Id', 'Description', 'Processed', 'Music', ),
        self::TYPE_CAMELNAME     => array('tag', 'uploadDate', 'title', 'id', 'description', 'processed', 'music', ),
        self::TYPE_COLNAME       => array(EpisodeTableMap::COL_TAG, EpisodeTableMap::COL_UPLOAD_DATE, EpisodeTableMap::COL_TITLE, EpisodeTableMap::COL_ID, EpisodeTableMap::COL_DESCRIPTION, EpisodeTableMap::COL_PROCESSED, EpisodeTableMap::COL_MUSIC, ),
        self::TYPE_FIELDNAME     => array('tag', 'upload_date', 'title', 'id', 'description', 'processed', 'music', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Tag' => 0, 'UploadDate' => 1, 'Title' => 2, 'Id' => 3, 'Description' => 4, 'Processed' => 5, 'Music' => 6, ),
        self::TYPE_CAMELNAME     => array('tag' => 0, 'uploadDate' => 1, 'title' => 2, 'id' => 3, 'description' => 4, 'processed' => 5, 'music' => 6, ),
        self::TYPE_COLNAME       => array(EpisodeTableMap::COL_TAG => 0, EpisodeTableMap::COL_UPLOAD_DATE => 1, EpisodeTableMap::COL_TITLE => 2, EpisodeTableMap::COL_ID => 3, EpisodeTableMap::COL_DESCRIPTION => 4, EpisodeTableMap::COL_PROCESSED => 5, EpisodeTableMap::COL_MUSIC => 6, ),
        self::TYPE_FIELDNAME     => array('tag' => 0, 'upload_date' => 1, 'title' => 2, 'id' => 3, 'description' => 4, 'processed' => 5, 'music' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('id', 'Id', 'VARCHAR', true, 255, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EpisodeTableMap::COL_TAG);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EpisodeTableMap::COL_TAG, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(EpisodeTableMap::COL_TAG) && $criteria->keyContainsValue(EpisodeTableMap::COL_TAG) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.EpisodeTableMap::COL_TAG.')');
        }
